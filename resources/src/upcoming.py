...
from util import catchall_ui, lirc_hack, timed, run_async, catchall
...
# ==============================================================================
class UpcomingRecordingsWindow(ui.BaseWindow):
    ...
    def render(self):
        ...
        for i, program in enumerate(self.programs):
            ...
            if channel and channel.getIconPath() and len(airdate) == 0:
