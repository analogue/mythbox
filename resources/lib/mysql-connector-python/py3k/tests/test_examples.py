...
class TestExamples(tests.MySQLConnectorTests):
    ...
    def test_dates(self):
        """examples/dates.py"""
        try:
            import py3k.examples.dates as exp
        except Exception as e:
            self.fail(e)
        self._exec_main(exp)
    ...
    def test_engines(self):
        """examples/engines.py"""
        try:
            import py3k.examples.engines as exp
        except:
            self.fail()
        self._exec_main(exp)
    ...
    def test_inserts(self):
        """examples/inserts.py"""
        try:
            import py3k.examples.inserts as exp
        except Exception as e:
            self.fail(e)
        self._exec_main(exp)
    ...
    def test_transactions(self):
        ...
        try:
            import py3k.examples.transaction as exp
        except Exception as e:
            self.fail(e)
        self._exec_main(exp)
    ...
    def test_unicode(self):
        """examples/unicode.py"""
        try:
            import py3k.examples.unicode as exp
        except Exception as e:
            self.fail(e)
        self._exec_main(exp)
    ...
    def test_warnings(self):
        ...
        try:
            import py3k.examples.warnings as exp
        except Exception as e:
            self.fail(e)
        self._exec_main(exp)
