...
class ClientError(object):
    ...
    def __new__(cls):
        raise TypeError("Can not instanciate from {name}".format(name=cls.__name__))
...
class InterfaceError(Error):
    def __init__(self, msg=None, errno=None, values=None):
        Error.__init__(self, msg, errno, values)
