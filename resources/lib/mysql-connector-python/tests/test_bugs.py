...
class Bug380528(tests.MySQLConnectorTests):
    ...
    def test_old_password(self):
        ...
        self.assertRaises(errors.NotSupportedError,mysql.MySQL,**test_config)
...
class Bug499362(tests.MySQLConnectorTests):
    ...
    def test_charset(self):
        ...
        config = self.getMySQLConfig()
        config['charset'] = 'latin7'
        db = mysql.MySQL(**config)
        c = db.cursor()
        
        ver = db.get_server_version()
        if ver < (5,1,12):
            exp1 = [(u'character_set_client', u'latin7'), 
                (u'character_set_connection', u'latin7'),
                (u'character_set_database', u'utf8'),
                (u'character_set_filesystem', u'binary'),
                (u'character_set_results', u'latin7'),
            ...
            exp1 = [(u'CHARACTER_SET_CONNECTION', u'latin7'),
                (u'CHARACTER_SET_CLIENT', u'latin7'),
                (u'CHARACTER_SET_RESULTS', u'latin7')]
...
class Bug499410(tests.MySQLConnectorTests):
    ...
    def test_charset(self):
        ...
        exp_latin7 = [('dzie\xf1 dobry!',), ('cze\xfa\xe3!',)]
        exp_unicode = [(u'dzie\u0144 dobry!',), (u'cze\u015b\u0107!',)]
        ...
        try:
            c.execute('DROP TABLE IF EXISTS %s' % (tbl))
            c.execute('CREATE TABLE %s (c1 VARCHAR(60)) charset=latin7' % (tbl))
        except:
        ...
        self.assertEqual(exp_latin7,res_latin7)
...
class Bug551533and586003(tests.MySQLConnectorTests):
    """lp: 551533, 586003: impossible to retrive big result sets"""
