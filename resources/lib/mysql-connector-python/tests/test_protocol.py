...
class MySQLProtocol(tests.MySQLConnectorTests):
    ...
    def test__recv_packet(self):
        ...
        self.cnx.buf.append("\x47\x00\x00\x02\xff")
        self.assertRaises(errors.Error,self.prtcl._recv_packet)
        
        exp = '\x01\x00\x00\x01\x00'
    ...
    def test__pkt_make_auth(self):
        ...
        exp = {
            'allset':\
            '\x3e\x00\x00\x00\x0d\xa2\x03\x00\x00\x00\xa0\x00'\
            ...
            'nopass':\
            '\x2a\x00\x00\x00\x0d\xa2\x03\x00\x00\x00\xa0\x00'\
            '\x21\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00'\
            '\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00'\
            '\x68\x61\x6d\x00\x00\x74\x65\x73\x74\x00',
            'nouser':\
            '\x3b\x00\x00\x00\x0d\xa2\x03\x00\x00\x00\xa0\x00'\
            '\x21\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00'\
            '\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00'\
            ...
            '\x5b\x74\x65\x73\x74\x00',
            'nodb':\
            '\x3a\x00\x00\x00\x0d\xa2\x03\x00\x00\x00\xa0\x00'\
            '\x21\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00'\
            '\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00'\
            '\x68\x61\x6d\x00\x14\x3a\x07\x66\xba\xba\x01\xce'\
            '\xbe\x55\xe6\x29\x88\xaa\xae\xdb\x00\xb3\x4d\x91'\
    ...
    def test__pkt_make_changeuser(self):
        ...
        exp = {
            'allset':\
            '\x21\x00\x00\x00\x11\x68\x61\x6d\x00\x14\x3a\x07'\
            '\x66\xba\xba\x01\xce\xbe\x55\xe6\x29\x88\xaa\xae'\
            '\xdb\x00\xb3\x4d\x91\x5b\x74\x65\x73\x74\x00\x08'\
            '\x00',
            'nopass':\
            '\x0d\x00\x00\x00\x11\x68\x61\x6d\x00\x00\x74\x65'\
            '\x73\x74\x00\x08\x00',
            }
